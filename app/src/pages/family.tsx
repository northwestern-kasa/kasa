          ...
          <div id="familyMain">
            ...
            <div className="mb-16">
              <div className="flex items-center justify-center md:relative md:items-start md:justify-start">
                <Image src={ggr} alt="family" className="w-[400px] h-[400px] md:w-[320px] md:h-[320px] lg:w-[400px] lg:h-[400px] 2xl:w-[500px] 2xl:h-[500px]"/>
              </div>
              <div className="flex items-center justify-center md:reltive md:-mt-[192px] lg:-mt-[272px] 2xl:-mt-[372px]">
                <Image src={silla} alt="family" className="w-[400px] h-[400px] -mt-32 md:w-[320px] md:h-[320px] lg:w-[400px] lg:h-[400px] 2xl:w-[500px] 2xl:h-[500px]" />
              </div>
              <div className="flex items-center justify-center md:relative md:items-end md:justify-end md:-mt-[225px] lg:-mt-[304px] 2xl:-mt-[404px]">
                <Image src={baekjae} alt="family" className="w-[400px] h-[400px] -mt-24 md:w-[320px] md:h-[320px] lg:w-[400px] lg:h-[400px] 2xl:w-[500px] 2xl:h-[500px]"/>
              </div>
            </div>
          </div>
        </div>
