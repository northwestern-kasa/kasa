  ...
  return (
    <section id="splash" className=" h-[75vh] ">
      ...
      <img
        src={topMidLeftBlob}
        alt="blob"
        className="absolute top-0 left-32 w-[100px] h-[75px] sm:left-52 sm:w-[125px] sm:h-[100px] md:left-60 md:w-[175px] lg:left-72 lg:w-[250px] lg:h-[125px] xl:w-[350px] xl:h-[150px] 2xl:w-[500px] 2xl:h-[175px]"
      />
      <img
        src={topMidRightBlob}
        alt="blob"
        className="absolute -top-16 right-24 w-[125px] h-[150px] sm:right-40 sm:w-[150px] sm:h-[150px] md:right-44 md:w-[175px] lg:right-64 lg:w-[300px] lg:h-[150px] xl:right-80 xl:w-[350px] xl:h-[175px] 2xl:right-96 2xl:w-[450px] 2xl:h-[200px]"
      />
      <img
        src={topRightBlob}
        alt="blob"
        className="absolute top-0 right-0 w-[100px] h-[100px] sm:w-[150px] sm:h-[150px] md:w-[200px] lg:w-[300px] lg:h-[200px] xl:h-[300px] 2xl:h-[350px] 2xl:w-[400px]"
      />
      <img
        src={midLeftBlob}
        alt="blob"
        className="absolute top-24 -left-5 w-[100px] h-[250px] sm:top-40 sm:w-[125px] sm:h-[250px] md:top-52 md:w-[150px] md:h-[325px] lg:w-[175px] lg:h-[400px] xl:top-64 xl:w-[200px] xl:h-[450px] 2xl:h-[450px]"
      />
      <img
        src={midRightBlob}
        alt="blob"
      ...
      <div id="content" className="h-full flex items-center justify-center">
        ...
        >
          ...
          {/* <div
            ...
            className={`
                    ${
                      currentPath == "/" || currentPath == "/" ? "" : "hidden"
                    } flex flex-col space-y-2 items-center text-center absolute top-[25vh]`}
          >
            <p
              id="learn-more"
              className={`${currentPath == "/" ? "" : "hidden"} w-3/4`}
            >
              Learn more about Northwestern&apos;s Korean American Student
              Association
            </p>
            ...
            <div
              id="arrow-container"
              className="w-10 h-10 rounded-full navBarShadow flex items-center justify-center"
            >
