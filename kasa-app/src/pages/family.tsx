  ...
  return (
    <div className={""}>
      <main className="">
        ...
        <div
          id="familyContent"
          className="mt-10 mb-24 flex flex-col items-center"
        >
          <div id="familyMain">
            ...
            <div className="flex items-center justify-center">
              <p className="text-center justify-center mt-4 w-4/5 px-10">
            ...
            <div className="mb-16">
              ...
              <div className="flex items-center justify-center md:relative md:-mt-[192px] lg:-mt-[272px] 2xl:-mt-[372px]">
                <img
                  src={silla}
                  alt="family"
                  loading="lazy"
